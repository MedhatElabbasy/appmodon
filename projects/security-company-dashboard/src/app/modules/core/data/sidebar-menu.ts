import { Roles, Lookup } from 'projects/tools/src/public-api';
...
export const SIDEBAR_LIST: MenuItem[] = [
  ...
  },
  {
    ...
    icon: null,
    image: 'assets/images/icons/man-in-suit-and-tie.png',
    children: null,
    role: [Roles.SecuritCompany, Roles.VirtualAdmin, Roles.SecurityCompanyUser],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'managment',
        link: Routing.settings.children.managment,
        icon: 'construct',
        image: null,
        role: [
          Roles.SecuritCompany,
      ...
      },
      {
        ...
        link: Routing.settings.children.EmergencyContact,
        icon: 'call',
        image: null,
        role: [
          Roles.SecuritCompany,
